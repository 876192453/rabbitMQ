...
public class Consumer_SMS {
    //队列名称
    private static final String QUEUE_INFO_SMS = "helloWorld";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            channel.queueBind(EXCHANGE_FANOUT_INFORM,QUEUE_INFO_SMS,"");
            ...
            */
            ...
            channel.basicConsume(QUEUE_INFO_SMS, true,defaultConsumer );
